...
/**
 * Construye indicadores, actividad y riesgos del usuario de Desarrollo a partir
 * de los sistemas y sus validaciones persistidas.
 */
@Service
@RequiredArgsConstructor
public class DashboardDesarrolloService {
