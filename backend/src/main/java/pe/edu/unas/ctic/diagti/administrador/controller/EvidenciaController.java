...
public class EvidenciaController {
    ...
    public List<EvidenciaDTO> listarEvidencias(
        ...
        return evidenciaService.listarEvidencias(busqueda, modulo, responsable, estado);
    }

    @GetMapping("/stats")
    public EvidenciaStatsDTO getStats() {
        return evidenciaService.obtenerStats();
    }

    @GetMapping("/{id}")
    public EvidenciaDTO obtenerPorId(@PathVariable Long id) {
