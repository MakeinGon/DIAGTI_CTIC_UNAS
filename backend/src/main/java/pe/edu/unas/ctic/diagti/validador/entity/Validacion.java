...
/**
 * Entidad del módulo validador sobre tabla oficial {@code validaciones}.
 * Nombre JPA único para no colisionar con DirectorValidacionEntity.
 */
@Entity(name = "ValidadorValidacion")
