...
public class EditarSistemaController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<EditarSistemaResponseDTO> editarSistema(
    ...
    public ResponseEntity<EditarSistemaResponseDTO> subirEvidencia(
            @PathVariable Long id,
    ...
    @PostMapping("/{id}/urls")
    public ResponseEntity<EditarSistemaResponseDTO> agregarUrl(
            @PathVariable Long id,
    ...
    public ResponseEntity<EditarSistemaResponseDTO> agregarIntegracion(
            @PathVariable Long id,
    ...
    public ResponseEntity<EditarSistemaResponseDTO> enviarAValidacion(@PathVariable Long id) {
